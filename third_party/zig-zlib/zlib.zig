...
pub fn create(b: *std.build.Builder, target: std.zig.CrossTarget, optimize: std.builtin.Mode) Library {
    const ret = b.addStaticLibrary(.{ .name = "zlib", .target = target, .optimize = optimize });
    ret.linkLibC();
